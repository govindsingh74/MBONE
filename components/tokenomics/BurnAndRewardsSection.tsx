    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {mechanisms.map((mechanism, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative rounded-2xl p-8 shadow-lg border overflow-hidden hover-lift"
            >
              {/* Card Background Image */}
              <div
                className="absolute inset-0 bg-cover bg-center"
                style={{ backgroundImage: `url(${mechanism.image})` }}
              />
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 bg-gradient-to-r from-brand-primary to-brand-secondary rounded-2xl p-8 text-center text-black-500"
        >
          <h3 className="text-2xl font-bold mb-4">The Power of Diamond Hands</h3>
          <p className="text-lg leading-relaxed max-w-3xl mx-auto text-grey-500">
